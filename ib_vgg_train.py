...
def main():
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        train(train_loader, model, criterion, optimizer, epoch, writer,  kl_alpha)
...
def train(train_loader, model, criterion, optimizer, epoch, writer, kl_alpha):
    """
    Run one train epoch
    """
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        kl_losses.update(kl_total.data[0] * kl_fac, input.size(0))
